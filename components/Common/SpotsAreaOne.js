...
const SpotsAreaOne = ({
	...
	return (
		<>
			<section
				className={`spots-area ptb-100 ${bgColor}`}
			>
										...
										>
											<div className="single-listings-box">
												<div className="listings-image">
													...
													>
                                                        {list.imagesGallery .length > 0 && list.imagesGallery.map(
                                                            ( gal, i ) => (
                                                                <SwiperSlide 
                                                                key={i}
